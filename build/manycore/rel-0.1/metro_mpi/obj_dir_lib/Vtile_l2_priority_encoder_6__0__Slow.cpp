...
VL_ATTR_COLD void Vtile_l2_priority_encoder_6___ctor_var_reset(Vtile_l2_priority_encoder_6* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vtile_l2_priority_encoder_6___ctor_var_reset\n"); );
