...
#ifndef VERILATED_VTILE_DYNAMIC_NODE_TOP_WRAP_H_
#define VERILATED_VTILE_DYNAMIC_NODE_TOP_WRAP_H_  // guard

#include "verilated.h"
class Vtile_dynamic_output_top;


class Vtile__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vtile_dynamic_node_top_wrap final {
  public:
    // CELLS
    Vtile_dynamic_output_top* __PVT__dynamic_node_top__DOT__north_output;
    Vtile_dynamic_output_top* __PVT__dynamic_node_top__DOT__east_output;
    Vtile_dynamic_output_top* __PVT__dynamic_node_top__DOT__south_output;
    Vtile_dynamic_output_top* __PVT__dynamic_node_top__DOT__west_output;
    Vtile_dynamic_output_top* __PVT__dynamic_node_top__DOT__proc_output;
    ...
    struct {
        ...
        CData/*0:0*/ __PVT__dynamic_node_top__DOT__north_input__DOT__NIB__DOT__yummy_out_f;
        ...
        CData/*0:0*/ __PVT__dynamic_node_top__DOT__east_input__DOT__NIB__DOT__yummy_out_f;
    ...
    struct {
        ...
        CData/*0:0*/ __PVT__dynamic_node_top__DOT__south_input__DOT__NIB__DOT__yummy_out_f;
    ...
    // CONSTRUCTORS
    Vtile_dynamic_node_top_wrap() = default;
    ~Vtile_dynamic_node_top_wrap() = default;
    void ctor(Vtile__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtile_dynamic_node_top_wrap);
